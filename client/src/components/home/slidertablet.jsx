...
import image_00 from '../../assets/images/home_slider_991_00.png'
import image_01 from '../../assets/images/home_slider_991_01.png'
import image_02 from '../../assets/images/home_slider_991_02.png'
import image_03 from '../../assets/images/home_slider_991_03.png'
            ...
            <div id="carouselSliderHome" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval='3000'>
                        <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_00})`, backgroundSize: 'cover', backgroundPosition: 'center',
                            backgroundRepeat: 'no-repeat' }}>
                            <div style={{width: '100%', height: '100%', background: 'rgba(39, 39, 39, 0.5)'}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval='3000'>
                        <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_01})`, backgroundSize: 'cover', backgroundPosition: 'center',
                            backgroundRepeat: 'no-repeat' }}>
                            <div style={{width: '100%', height: '100%', background: 'rgba(39, 39, 39, 0.5)'}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval='3000'>
                        <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_02})`, backgroundSize: 'cover', backgroundPosition: 'center',
                            backgroundRepeat: 'no-repeat' }}>
                            <div style={{width: '100%', height: '100%', background: 'rgba(39, 39, 39, 0.5)'}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval='3000'>
                        <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_03})`, backgroundSize: 'cover', backgroundPosition: 'center',
                            backgroundRepeat: 'no-repeat' }}>
                            <div style={{width: '100%', height: '100%', background: 'rgba(39, 39, 39, 0.5)'}}/>
                        </div>
                    </div>
