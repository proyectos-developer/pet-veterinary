...
export default function BodyHome({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 800 / proporcional}}>
                ...
                <div className='position-relative' style={{width: '50%', height: 800 / proporcional}}>
                    <img src={home_foto_02} style={{width: '100%', height: 800 / proporcional}}/>
