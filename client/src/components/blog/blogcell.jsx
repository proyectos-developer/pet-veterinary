        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional,
            ...
            <div style={{width: '100%', height: 'auot'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[0]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[1]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[2]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[3]}/>
                </div>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[4]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[5]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[6]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[7]}/>
                </div>
                <div className='d-flex justify-content-center position-relative' style={{width: '100%', height: 'auto'}}>
                    <div className='position-absolute start-50 translate-middle rounded' style={{width: '100%', height: 300 / proporcional, background: 'rgb(240, 67, 54)', top: '40%'}}>
                        <div className='d-flex justify-content-end' style={{width: '100%', height: 62 / proporcional}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[8]}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <CardBlogCell proporcional={proporcional} articulo={articulos[9]}/>
                </div>
            </div>
        </div>
    )
