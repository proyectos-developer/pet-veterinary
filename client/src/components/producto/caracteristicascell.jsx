...
export default function CaracterisciasTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div style={{width: '100%', height: 100 / proporcional, padding: 20 / proporcional, background: seleleccion_pestaña === 'descripcion' ? '#f7f7f5' : 'white',
                ...
                <div style={{width: '100%', height: 100 / proporcional, padding: 20 / proporcional, background: seleleccion_pestaña === 'informacion' ? '#f7f7f5' : 'white',
                        borderTopRightRadius: 8 / proporcional, borderTopLeftRadius: 8 / proporcional}}
                ...
                <div style={{width: '100%', height: 100 / proporcional, padding: 20 / proporcional, background: seleleccion_pestaña === 'calificaciones' ? '#f7f7f5' : 'white',
                        borderTopRightRadius: 8 / proporcional, borderTopLeftRadius: 8 / proporcional}}
