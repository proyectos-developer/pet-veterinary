    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional, paddingLeft: 150 / proporcional, paddingRight: 150 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '20%', height: 'auto', padding: 20 / proporcional}}>
                ...
                <div style={{width: '35%', height: 'auto', padding: 20 / proporcional}}>
                    <p style={{fontSize: 30 / proporcional, lineHeight: `${32 / proporcional}px`, marginBottom: 50 / proporcional, color: '#4a4a4a', 
                        cursor: 'default', fontWeight: 900, fontFamily: 'Nunito, sans-serif', wordWrap: 'break-word'}}>
                        Instagram
                    </p>
                    ...
                    <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                        <img src={image_footer_00} style={{width: 150 / proporcional, height: 150 / proporcional, borderTopLeftRadius: 8 / proporcional, marginRight: 10 / proporcional}}/>
                        <img src={image_footer_01} style={{width: 150 / proporcional, height: 150 / proporcional, marginRight: 10 / proporcional}}/>
                        <img src={image_footer_02} style={{width: 150 / proporcional, height: 150 / proporcional, borderBottomLeftRadius: 8 / proporcional}}/>
                    </div>

                    <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                        <img src={image_footer_03} style={{width: 150 / proporcional, height: 150 / proporcional, borderTopRightRadius: 8 / proporcional, marginRight: 10 / proporcional}}/>
                        <img src={image_footer_04} style={{width: 150 / proporcional, height: 150 / proporcional, marginRight: 10 / proporcional}}/>
                        <img src={image_footer_05} style={{width: 150 / proporcional, height: 150 / proporcional, borderBottomRightRadius: 8 / proporcional}}/>
                    </div>
                </div>
            </div>
        </div>
