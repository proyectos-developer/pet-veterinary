...
export default function NuestroEquipoCell({proporcional}) {

    const [boton_personal, setBotonPersonal] = useState('false')

    return (
        <div style={{width: '100%', height: 'auto', paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional, paddingTop: 20 / proporcional, paddingBottom: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_00} style={{width: '100%', height: 600 / proporcional}}/>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_01} style={{width: '100%', height: 600 / proporcional}}/>
                        <div className='position-absolute' style={{width: 110 / proporcional, height: 110 / proporcional, top: 32 / proporcional, left: 32 / proporcional,
                            backgroundImage: `url(${icono_cloud})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <img className='position-absolute top-50 start-50 translate-middle' src={icono_rocket} style={{width: 32 / proporcional, height: 32 / proporcional}}/>
                        </div>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_02} style={{width: '100%', height: 600 / proporcional}}/>
                        <div className='position-absolute' style={{width: 110 / proporcional, height: 110 / proporcional, top: 32 / proporcional, left: 32 / proporcional,
                            backgroundImage: `url(${icono_cloud})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <img className='position-absolute top-50 start-50 translate-middle' src={icono_rocket} style={{width: 32 / proporcional, height: 32 / proporcional}}/>
                        </div>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_03} style={{width: '100%', height: 600 / proporcional}}/>
                        <div className='position-absolute' style={{width: 110 / proporcional, height: 110 / proporcional, top: 32 / proporcional, left: 32 / proporcional,
                            backgroundImage: `url(${icono_cloud})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <img className='position-absolute top-50 start-50 translate-middle' src={icono_rocket} style={{width: 32 / proporcional, height: 32 / proporcional}}/>
                        </div>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, marginBottom: 25 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_04} style={{width: '100%', height: 600 / proporcional}}/>
                        <div className='position-absolute' style={{width: 110 / proporcional, height: 110 / proporcional, top: 32 / proporcional, left: 32 / proporcional,
                            backgroundImage: `url(${icono_cloud})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <img className='position-absolute top-50 start-50 translate-middle' src={icono_rocket} style={{width: 32 / proporcional, height: 32 / proporcional}}/>
                        </div>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional}}>
                    <div className='position-relative' style={{width: 'auto', height: 'auto'}}>
                        <img className='rounded' src={image_equipo_05} style={{width: '100%', height: 600 / proporcional}}/>
                        <div className='position-absolute' style={{width: 110 / proporcional, height: 110 / proporcional, top: 32 / proporcional, left: 32 / proporcional,
                            backgroundImage: `url(${icono_cloud})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <img className='position-absolute top-50 start-50 translate-middle' src={icono_rocket} style={{width: 32 / proporcional, height: 32 / proporcional}}/>
                        </div>
