...
export default function ComentariosCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 400 / proporcional}}>
                <div className='position-relative' style={{width: '100%', height: 400 / proporcional}}>
                    <img src={image_comentarios} style={{width: '100%', height: 400 / proporcional}}/>
                    <div className='position-absolute top-0 start-0' 
                        style={{width: '100%', height: 400 / proporcional, background: 'rgba(39, 39, 39, 0.6)'}}/>
                </div>
            </div>
        </div>
    )
