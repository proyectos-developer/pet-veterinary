...
import image_equipo from '../../../assets/images/image_equipo_1920.png'
    ...
    return (
        <div style={{width: '100%', height: 800 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 800 / proporcional}}>
                <div style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_equipo})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
