...
export default function ConoceEquipoCell({proporcional}) {

        return (
            <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
