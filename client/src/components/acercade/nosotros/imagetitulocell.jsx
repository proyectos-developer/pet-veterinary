...
import image_nosotros from '../../../assets/images/image_nosotros_499.png'
    ...
    return (
        <div style={{width: '100%', height: 600 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 600 / proporcional}}>
                <div style={{width: '100%', height: 600 / proporcional, backgroundImage: `url(${image_nosotros})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
