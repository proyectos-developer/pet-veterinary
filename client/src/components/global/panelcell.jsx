  ...
  const {open_menu_main} = useSelector(({data_actions}) => data_actions)
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
          ...
          {
            open_menu_main ? (
              <div className='position-fixed' style={{width: '100%', height: '100%', top: 225 / proporcional, zIndex: 99999, background: 'transparent'}}>
                  <div className='d-flex justify-content-end' style={{width: '100%', height: '100%'}}>
                      <div className='' style={{width: '75%', height: '100%', background: 'rgba(255, 255, 255, 0.6)', padding: 20 / proporcional}}>
