...
import FiltrosTienda from '../tienda/filtrostienda'
...
export default function Pos({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 150 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '70%', height: 'auto'}}>
                    <Contenido proporcional={proporcional} articulo={articulos[parseInt(location.pathname.split('/')[2])]}/>
                </div>
