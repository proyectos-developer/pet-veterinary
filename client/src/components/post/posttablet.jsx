...
import FiltrosTiendaTablet from '../tienda/filtrostiendatablet'
...
export default function PosTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 60 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <ContenidoTablet proporcional={proporcional} articulo={articulos[parseInt(location.pathname.split('/')[2])]}/>
            </div>
            <div style={{width: '100%', height: 'auto'}}>
                <FiltrosTiendaTablet proporcional={proporcional}/>
            </div>
        </div>
    )
}
