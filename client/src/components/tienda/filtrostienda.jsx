...
import CardProductoRelacionado from './card/productorelacionado.jsx'

export default function FiltrosTienda({proporcional}) {

    const [buscar_producto, setBuscarProducto] = useState ('')
    const [seleccion_tag, setSeleccionTag] = useState('')
    
    return (
        <div className='' style={{width: '95%', height: 'auto'}}>
            <div className='d-flex' style={{width: '100%', height: 60 / proporcional, marginBottom: 50 / proporcional}}>
                <input 
            ...
            <div style={{width: '100%', height: 'auto', background: '#f7f7f5', padding: 20 / proporcional, marginBottom: 50 / proporcional}}>
                ...
                <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <CardProductoRelacionado proporcional={proporcional}/>
                    <CardProductoRelacionado proporcional={proporcional}/>
                    <CardProductoRelacionado proporcional={proporcional}/>
                </div>
            </div>
