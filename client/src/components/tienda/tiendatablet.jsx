...
import FiltrosTiendaTablet from './filtrostiendatablet.jsx'
            ...
            <div className='' style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                        <CardProductoTablet proporcional={proporcional} opcion={1}/>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                        <CardProductoTablet proporcional={proporcional} opcion={2}/>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                        <CardProductoTablet proporcional={proporcional} opcion={1}/>
                    </div>
