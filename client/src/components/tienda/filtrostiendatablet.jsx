...
import CardProductoRelacionadoTablet from './card/productorelacionadotablet.jsx'
    ...
    return (
        <div className='' style={{width: '95%', height: 'auto'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '49%', height: 'auto', background: '#f7f7f5', padding: 20 / proporcional, marginBottom: 50 / proporcional}}>
                ...
                <div style={{width: '49%', height: 'auto', background: '#f7f7f5', padding: 20 / proporcional, marginBottom: 50 / proporcional}}>
                    ...
                    <div className='' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                        <CardProductoRelacionadoTablet proporcional={proporcional}/>
                        <CardProductoRelacionadoTablet proporcional={proporcional}/>
                        <CardProductoRelacionadoTablet proporcional={proporcional}/>
                    </div>
                </div>
