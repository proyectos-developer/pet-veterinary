...
import image_00 from '../../assets/images/image_contactanos_v1_499.png'
...
export default function ContactoCell({proporcional}) {    
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional}}>
            <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingBottom: 80 / proporcional}}>
